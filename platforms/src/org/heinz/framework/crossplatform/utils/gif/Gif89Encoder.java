...
public class Gif89Encoder {
	...
	private List vFrames = new ArrayList();
	 ...
	 */
	public final void addFrame(Image image) throws IOException {
	 ...
	 *   generality :)
	 */
	public final void addFrame(int width, int height, byte ci_pixels[])
			throws IOException {
	...
	public void setUniformDelay(int interval) {
		for(int i = 0; i < vFrames.size(); ++i) {
			((Gif89Frame) vFrames.get(i)).setDelay(interval);
		}
	}
