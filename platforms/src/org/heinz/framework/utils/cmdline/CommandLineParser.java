...
public class CommandLineParser {
	...
	private static final Map optionsByName = new HashMap();

	private final Map optionValuesByName = new HashMap();

	private final List arguments = new ArrayList();

	private final List unknownOptions = new ArrayList();

	private final List errorOptions = new ArrayList();
	...
	public String toString() {
		StringBuilder s = new StringBuilder("ArgumentParser:\n");
	...
	public static void main(String[] args) throws Exception {
		...
		CommandLineParser.addOption(new CommandLineOption("h", Integer.class, 1));
		CommandLineParser.addOption(new CommandLineOption("w", Integer.class, 2));
		CommandLineParser.addOption(new CommandLineOption("z", Integer.class, 3));
