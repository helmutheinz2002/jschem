...
public abstract class AbstractOptions {
	...
	private static Map converters = getAccessors();
	...
	public int getIntOption(String key) {
		return ((Integer) getOption(key)).intValue();
	}
	
	public double getDoubleOption(String key) {
		return ((Double) getOption(key)).doubleValue();
	}
	
	public boolean getBoolOption(String key) {
		return ((Boolean) getOption(key)).booleanValue();
	}
	...
	class ListSuffixComparator implements Comparator {
		public int compare(Object arg0, Object arg1) {
			...
			int idx1 = new Integer(key1.substring(i+1)).intValue();
			i = key2.lastIndexOf('.');
			int idx2 = new Integer(key2.substring(i+1)).intValue();
