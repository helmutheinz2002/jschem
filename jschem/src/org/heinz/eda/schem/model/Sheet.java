...
public class Sheet implements ComponentListener {
	...
	private Map connectedObjectsByHandle = new HashMap();
	private Map handlesByPosition = new HashMap();
	private Set checkingAttachHandles = new HashSet();
	...
	public List ungroup(Component group) {
		...
		List components = new ArrayList(group.getComponents());
	...
	public void setDirty(boolean dirty) {
		...
		this.dirty = dirty;
		pcs.firePropertyChange(PROPERTY_DIRTY, new Boolean(oldVal), new Boolean(dirty));
	}
