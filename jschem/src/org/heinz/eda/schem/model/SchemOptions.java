...
public class SchemOptions extends AbstractOptions {
	public static final String PROPERTY_GRID_VISIBLE = defineOption("Settings.gridVisible", new Boolean(true));
	public static final String PROPERTY_SMART_JUNCTIONS = defineOption("Settings.smartJunctions", new Boolean(true));
	public static final String PROPERTY_SMART_JUNCTIONS_OUTLINE = defineOption("Settings.smartJunctionsOutline", new Boolean(false));
	public static final String PROPERTY_GRID_SNAP = defineOption("Settings.gridSnap", new Boolean(true));
	...
	public static final String PROPERTY_ANTIALIASING = defineOption("Settings.antiAliasing", new Boolean(checkSystemProperty("apple.awt.antialiasing", "on")));
	public static final String PROPERTY_FILL_WITH_SELECTION_COLOR = defineOption("Settings.fillWithSelectionColor", new Boolean(false));
	...
	public static final String PROPERTY_SELECTION_CONTAINS = defineOption("Settings.selectionContains", new Boolean(true));
	public static final String PROPERTY_AUTONUMBER_PAGE_OFFSET = defineOption("Settings.autonumberPageOffset", new Integer(100));
	public static final String PROPERTY_REGISTER_FILETYPE = defineOption("Settings.registerFileType", new Boolean(true));
