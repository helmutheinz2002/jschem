...
public class Orientation implements Serializable {
	private static Orientation[] ORIENTATIONS = buildOrientations();
	
	public static Orientation RIGHT = ORIENTATIONS[0];
	public static Orientation UP = ORIENTATIONS[1];
	public static Orientation LEFT = ORIENTATIONS[2];
	public static Orientation DOWN = ORIENTATIONS[3];
	
	public static Orientation[] DIRECTIONS = { RIGHT, UP, LEFT, DOWN };
	
	public static Orientation FLIP_LEFT_RIGHT = new Orientation("FLIP_HORIZ", -1, 0, 0, 1, 0, "down.png", false, false, 0);
	public static Orientation FLIP_TOP_BOTTOM = new Orientation("FLIP_VERT", 1, 0, 0, -1, 0, "down.png", false, false, 0);
