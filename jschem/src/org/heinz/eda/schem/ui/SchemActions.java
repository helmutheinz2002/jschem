...
public class SchemActions extends AbstractActions {
    ...
    private SchemActions() {
    	...
    	exportSheetItem = new SchemAction("MENU_EXPORT_SHEET", "empty", null, new Integer(KeyEvent.VK_E));
    	exportSchematicsItem = new SchemAction("MENU_EXPORT_SCHEMATICS", "empty", null, new Integer(KeyEvent.VK_P));

        newSheetItem = new SchemAction("MENU_NEW_SHEET", "empty", null, new Integer(KeyEvent.VK_N));
        renameSheetItem = new SchemAction("MENU_RENAME_SHEET", "empty", null, new Integer(KeyEvent.VK_R));
        deleteSheetItem = new SchemAction("MENU_DELETE_SHEET", "empty", null, new Integer(KeyEvent.VK_D));
        sheetLeftItem = new SchemAction("MENU_SHEET_TAB_LEFT", "empty", null, new Integer(KeyEvent.VK_L));
        sheetRightItem = new SchemAction("MENU_SHEET_TAB_RIGHT", "empty", null, new Integer(KeyEvent.VK_I));
    	sheetSizeItem = new SchemAction("MENU_SHEET_SIZE", "empty", null, new Integer(KeyEvent.VK_G));
        
        saveComponentItem = new SchemAction("MENU_ADD_TO_LIBRARY", "empty", null, new Integer(KeyEvent.VK_A));
        groupComponentItem = new SchemAction("MENU_GROUP_COMPONENT", "empty", KeyStroke.getKeyStroke(KeyEvent.VK_G, menuMask), new Integer(KeyEvent.VK_G));
        groupSymbolItem = new SchemAction("MENU_GROUP_SYMBOL", "empty", null, new Integer(KeyEvent.VK_S));
        ungroupItem = new SchemAction("MENU_UNGROUP", "empty", KeyStroke.getKeyStroke(KeyEvent.VK_U, menuMask), new Integer(KeyEvent.VK_U));
        libraryItem = new SchemAction("MENU_LOAD_FROM_LIBRARY", "empty", KeyStroke.getKeyStroke(KeyEvent.VK_L, menuMask), new Integer(KeyEvent.VK_L));
        updateLibraryItem = new SchemAction("MENU_LIBRARY_UPDATE", "empty", null, new Integer(KeyEvent.VK_I));
        
        stackingMenu = new SchemAction("MENU_STACKING", "empty", null, new Integer(KeyEvent.VK_S));
        toFrontItem = new SchemAction("MENU_TO_FRONT", "empty", null, new Integer(KeyEvent.VK_F));
        toBackItem = new SchemAction("MENU_TO_BACK", "empty", null, new Integer(KeyEvent.VK_B));
        ...
        rotateItem = new SchemAction("MENU_ROTATE_ALL_LEFT", "rotate", KeyStroke.getKeyStroke(KeyEvent.VK_R, menuMask), new Integer(KeyEvent.VK_R));
        rotateNoTextItem = new SchemAction("MENU_ROTATE_BODY_LEFT", "rotatenotext", null, new Integer(KeyEvent.VK_T));
        flipLeftRightItem = new SchemAction(Orientation.FLIP_LEFT_RIGHT.name, "flipleftright", null, new Integer(KeyEvent.VK_H));
        flipTopBottomItem = new SchemAction(Orientation.FLIP_TOP_BOTTOM.name, "fliptopbottom", null, new Integer(KeyEvent.VK_V));
        flipLeftRightNoTextItem = new SchemAction("MENU_FLIP_BODY_HORIZONTALLY", "flipleftrightnotext", null, new Integer(KeyEvent.VK_L));
        flipTopBottomNoTextItem = new SchemAction("MENU_FLIP_BODY_VERTICALLY", "fliptopbottomnotext", null, new Integer(KeyEvent.VK_B));
    }
	...
	protected void setActionStates(ActionStateInfos stateInfos) {
		try {
			int numSheets = ((Integer) stateInfos.get(STATE_INFO_NUM_SHEETS)).intValue();
			boolean canMoveLeft = ((Boolean) stateInfos.get(STATE_INFO_CAN_MOVE_LEFT)).booleanValue();
			boolean canMoveRight = ((Boolean) stateInfos.get(STATE_INFO_CAN_MOVE_RIGHT)).booleanValue();
		...
		try {
			int numSelected = ((Integer) stateInfos.get(ActionStateInfos.STATE_INFO_NUM_SELECTED)).intValue();
			int numGroups = ((Integer) stateInfos.get(STATE_INFO_NUM_GROUPS)).intValue();
			int numPins = ((Integer) stateInfos.get(STATE_INFO_NUM_PINS)).intValue();
